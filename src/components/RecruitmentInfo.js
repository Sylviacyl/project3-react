...
<div>
    ...
    <Col sm={6} md={6} className="text-left">
      ...
      <p>Finding the right approach means we have to know each and every client’s business, understand their issues and determine actionable steps that work in their environment. What’s more, we treat each client, candidate, and contractor with the attention and respect they deserve, as befits our corporate values: integrity, respect, collaboration, empowerment and responsibility.</p>

      <p>And with Eleete Consulting,  you get local expertise backed by global resources and a network of professionals. We’re always at work - recruiting, motivating and developing people in markets around the world .</p>
      <Link to='/contact'>
