...
function CareerInfo() {
  ...
  return(
   ...
   <Col sm={6} md={6}>
      ...
      <p className="text-left">At Eleete Consulting, we believe that talent management means selecting the right people, developing their potential and fuelling their enthusiasm, building their commitment, and also supporting them through periods of change.
      ...
      <p className="text-left">Our clients look to us for support when they need to:</p>
...
<Col sm={6} md={6} >
     ...
     <p className="text-left">
      Find more about how we can meet your organisations talent needs or enhance your own career.
     </p>
